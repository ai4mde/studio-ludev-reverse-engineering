...
from extract_jinja2 import generate_diagram_json
...
# @pre -
# @post array with AI4MDE json strings for each app
def generate_diagram_json():
    ...
    for app_config in apps.get_app_configs():
        ...
        # Append diagram to diagrams array
        diagrams.append(rendered_json)
