...
from scripts.src.extract_jinja2 import get_arguments, extract_zip, get_project_info, projects_folder
...
# Fixture om sys.argv tijdelijk aan te passen
@pytest.fixture
...
def test_extract_zip_idempotent(dummy_zip_file):
    extract_zip(str(dummy_zip_file))
